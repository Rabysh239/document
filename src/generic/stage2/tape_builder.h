...
private:
  std::unique_ptr<dom::tape_writer> tape_;
...
simdjson_inline tape_builder::tape_builder(dom::immutable_document &doc) noexcept
: tape_(new simdjson::dom::tape_writer_to_immutable(doc)) {}

simdjson_inline tape_builder::tape_builder(dom::mutable_document &doc) noexcept
